...
try {
  ...
  if (parsed.command === "help") {
    ...
    await runEditCommand(parsed.prompt, parsed.options);
    ...
    await runProfileCommand(parsed.options);
  ...
  } else if (parsed.command === "vary") {
    await runVaryCommand(parsed.prompt, parsed.options);
  } else {
